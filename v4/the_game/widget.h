...
public:
    ...
    void triggeredLaserBeam();
    void triggeredMassiveBomb();
...
private:
    ...
    QGraphicsPixmapItem gameBackground_3;         //background img
    QGraphicsPixmapItem gameBackground_4;         //background img
    QGraphicsPixmapItem startupTitle;
    ...
    QGraphicsPixmapItem iconLife[5];
    QGraphicsPixmapItem gameOverWarning;
    QGraphicsPixmapItem gameWinInfo;
    QGraphicsPixmapItem gameSettings;
    ...
    QLabel* board_laserCount;
    QLabel* board_bombCount;
    QFont scoreFont;

    playerShip* playerShip_0 = new playerShip;
    playerShip* playerLaserBeam = new playerShip;
    ...
    bool laserPermission = true;
    bool bombPermission = true;
    ...
    QLabelGraphicsItem* laserCountLabelItem;
    QLabelGraphicsItem* bombCountLabelItem;
};
#endif // WIDGET_H
